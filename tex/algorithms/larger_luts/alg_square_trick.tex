...
$\vec s'_1 \gets \texttt{\gls{PBS}\_TFHE}(\vec s_1, x \mapsto x^2 \cdot \modulo{4^{-1}}{p})$ \\
$\vec s'_2 \gets \texttt{\gls{PBS}\_TFHE}(\vec s_2, x \mapsto \modulo{-1}{p} \cdot x^2 \cdot \modulo{4^{-1}}{p})$ \\
