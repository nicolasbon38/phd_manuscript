...
\TODO{Faire une figure qui explique l'utilisation classique, l'utilisation du FHE, et une figure qui vulgarise le bootstrapping}

\begin{figure}
	\centering
	\include{img/blocks_from_slides/simple_fhe.tex}
	\caption{The classical use of FHE}
	\label{fig:classical_usage_fhe}
	\TODO{Détailler caption + compacter pour que l'ensemble tienne sur une page + référencer dans le texte}
\end{figure}
