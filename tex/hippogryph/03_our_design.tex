...
\TODO{A revoir pour changer les références, mais devrait être globalement OK}
...
\begin{figure}
	...
	\caption{Structure of one round of AES with our method. Ciphertexts in blue live in $\Z_{17}$ while the ones in yellow are in $\Z_2$. Squares represent encryptions of one single bit while rectangles represent nibbles.} 
	\label{fig:our_design}
	\TODO{CHoisir des meilleures couleurs}
\end{figure}
