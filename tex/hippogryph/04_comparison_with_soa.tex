...
\end{adjustbox}
\end{table}
%\SB{est-ce que tous les paramètres ont été définis (e.g., $\sigma_{RLWE}$) ?}
...
\end{tabular}
\end{table}
%\footnote{https://tfhe.github.io/tfhe/}
%\footnote{https://github.com/virtualsecureplatform/TFHEpp}
%\footnote{https://github.com/zama-ai/tfhe-rs}
