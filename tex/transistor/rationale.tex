...
\TODO{Ca c'est à nous donc je peux le laisser tel quel ?}
% \section{Design Rationale}
% \label{sec:rationale}

% \lp{cette section ne contient finalement qu'une seule sous-section qui, je pense, pourrait être raccrochée à la section précédent (j'ai tendance à considèrer que la technique de contrôle du bruit fait partie de la description de Transistor)} \lp{J'ai implémenté le changement}
