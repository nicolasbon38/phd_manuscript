...
\begin{definition} (Negacyclic Accumulator)
	...
	\TODO{Dire quelque chose surl'encodage dans les MSB, (que veut dire f(i) en fait)}
...
\begin{figure}
	...
	\end{minipage}\hspace{1em}% Adjust the margin width as needed
	\begin{minipage}{0.49\linewidth}
		\centering
...
\TODO{Ecrire que ça ne change rien au paramétrage, avec une référence sur la bonne section}
...
\TODO{Est-ce que ke paragraphe ci-dessus n'est pas trop lourd ?}

\begin{figure}
	\centering
	\includegraphics[width=\textwidth]{img/to_harmonize/accumulator_odd.png}
...
\TODO{Aussi rapatrier le reste de la section sur l'implem ?}
